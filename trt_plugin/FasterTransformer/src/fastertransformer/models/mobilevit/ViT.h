...
#include "src/fastertransformer/models/mobilevit/ViTWeight.h"
#include "src/fastertransformer/utils/conv2d.h"

namespace fastertransformer {

template<typename T>
class MobileViTTransformer: public BaseLayer {
private:
...
public:
    MobileViTTransformer(size_t max_batch_size,
                   size_t embed_dim,
                   size_t head_num,
                   size_t inter_size,
                   size_t num_layer,
    ...
    MobileViTTransformer(MobileViTTransformer<T> const& vit_layer);
