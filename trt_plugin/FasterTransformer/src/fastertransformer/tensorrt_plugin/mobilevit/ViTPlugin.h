...
static const char* VIT_PLUGIN_NAME{"CustomMobileVisionTransformerPlugin"};
}  // namespace
...
template<typename T>
class MobileVisionTransformerPlugin: public nvinfer1::IPluginV2DynamicExt {
private:
    ...
    MobileViTTransformer<T>* vit_transformer_ = nullptr;
...
public:
    int sm_;
    MobileVisionTransformerPlugin(const std::string& name,
                            const int max_batch,
                            const int embed_dim,
                            const int seq_len,
                            const int num_heads,
    ...
    MobileVisionTransformerPlugin(const std::string& name, const void* data, size_t length);
    MobileVisionTransformerPlugin(const MobileVisionTransformerPlugin<T>& plugin);
    MobileVisionTransformerPlugin() = delete;

    ~MobileVisionTransformerPlugin();
...
class MobileVisionTransformerPluginCreator: public nvinfer1::IPluginCreator {
public:
    MobileVisionTransformerPluginCreator();
