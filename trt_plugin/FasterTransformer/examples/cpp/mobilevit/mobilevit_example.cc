    ...
    int batch_size, int img_size, int patch_size, int embed_dim, int head_num, int layer_num, int token_classifier)
{
    ...
    ViTWeight<T> params =
        ViTWeight<T>(embed_dim, inter_size, layer_num);
    ...
    MobileViTTransformer<T>* vit = new MobileViTTransformer<T>(max_batch,
                                                   embed_dim,
                                                   head_num,
                                                   inter_size,
                                                   layer_num,
    ...
    T *input_d, *output_d;
    deviceMalloc(&input_d, batch_size * seq_len * embed_dim, false);
